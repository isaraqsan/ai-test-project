...
import 'package:gibas/shared/typography/typography_component.dart' show TextComponent, TextTitleType;
...
class Component {
  ...
  static AppBar appBarDefault(String title, {PreferredSizeWidget? bottom}) {
    return AppBar(
      ...
      title: Text(
        title,
        style: const TextStyle(fontSize: 20, color: ColorPalette.white, fontWeight: FontWeight.bold),
      ),
      bottom: bottom,
    );
  }

  static AppBar appbarTitle(String title, {Color color = ColorPalette.primary}) {
    return AppBar(
  ...
  static Icon icon(IconData icon, {Color color = ColorPalette.white, double? size}) {
