...
class DataResult<T> {
  ...
  factory DataResult.fromJson(
    ...
    final String resonseCode = json['response_code'];
    final String? responseMessage = json['response_message'];
    final PageInfo? pageInfo = json['page_info'] != null ? PageInfo.fromJson(json['page_info']) : null;
